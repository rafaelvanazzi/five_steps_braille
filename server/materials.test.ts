...
vi.mock("./db", () => ({
  ...
  getRatingsForMaterial: vi.fn().mockResolvedValue({ average: 0, count: 0, ratings: [] }),
  ...
  getTotalDownloads: vi.fn().mockResolvedValue(0),
  getAllUsers: vi.fn().mockResolvedValue([]),
  getTotalUsers: vi.fn().mockResolvedValue(0),
  getTotalMaterials: vi.fn().mockResolvedValue(0),
  getTotalMessages: vi.fn().mockResolvedValue(0),
